...
// seriesRouter.post('/', validationCheck, (req, res, next) => {
//     const name = req.body.series.name,
//           description = req.body.series.description;
...
// seriesRouter.put('/:seriesId', validationCheck, (req, res, next) => {
//     const name = req.body.series.name,
//           description = req.body.series.description;
...
seriesRouter.delete('/:seriesId', (req, res, next) => {
    ...
    const issuesSql = `SELECT * FROM Issue WHERE series_id=${seriesId}`
